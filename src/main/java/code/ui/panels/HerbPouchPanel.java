...
public class HerbPouchPanel extends AbstractPanel {
    ...
    public HerbPouchPanel() {
        super(Settings.WIDTH - 200.0F * Settings.scale, 0.0F, -300.0F * Settings.scale, -300.0F * Settings.scale, null, true);
    }
    ...
    public void updatePositions() {
        ...
        if (this.hb.hovered && (!AbstractDungeon.isScreenUp || AbstractDungeon.screen == CurrentScreen.GAME_DECK_VIEW || AbstractDungeon.screen == CurrentScreen.HAND_SELECT || AbstractDungeon.screen == CurrentScreen.CARD_REWARD && AbstractDungeon.getCurrRoom().phase == RoomPhase.COMBAT)) {
        ...
        if ((this.hb.clicked || InputActionSet.drawPile.isJustPressed() || CInputActionSet.drawPile.isJustPressed()) && AbstractDungeon.screen == CurrentScreen.GAME_DECK_VIEW) {
            this.hb.clicked = false;
            this.hb.hovered = false;
            this.bannerHb.hovered = false;
            CardCrawlGame.sound.play("DECK_CLOSE");
            if (AbstractDungeon.previousScreen == CurrentScreen.GAME_DECK_VIEW) {
